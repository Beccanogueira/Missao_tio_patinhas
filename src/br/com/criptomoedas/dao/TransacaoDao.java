...
public class TransacaoDao extends ContaDao {
    ...
    public void cadastrar(Transacao transacao) throws SQLException {
        PreparedStatement stm = conexao.prepareStatement("INSERT INTO t_transacao (id_conta, id_usuario, saldo_total, numero_conta, id_transacao, id_moeda, data_hora, tipo_transacao, quantidade_moeda, preco_moeda) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
